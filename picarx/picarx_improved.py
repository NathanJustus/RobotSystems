...
try:
    ...
    print("This computer does not appear to be a picar system.  Shadowing hardware calls with substitute functions.")
...
class Picarx(object):
    ...
    def __init__(self, 
        ...
        self.dir_cali_val = 3
        self.cam_pan_cali_val = -17
        self.cam_tilt_cali_val = 8
        ...
        # transfer reference
        if not isinstance(self.line_reference,list):
        ...
        #shut down motor on function exit
    ...
    def forward(self, speed):
        ...
        if current_angle != 0:
            ...
            if current_angle > 0:
                ...
                self.set_motor_speed(1, speed)
                self.set_motor_speed(2, -1*speed* power_scale*frictionPowerScale)
        else:
            self.set_motor_speed(1, speed)
            self.set_motor_speed(2, -1*speed*frictionPowerScale)
